// src/features/admin/teams/AdminPaymentTeamProfile.tsx
import React, { useEffect } from 'react';
import { useParams, useSearchParams, useNavigate } from 'react-router-dom';
import { useDispatch, useSelector } from 'react-redux';
import { AppDispatch, RootState } from '../../../store';
import { fetchUsersByTeam } from '../../../store/slices/usersSlice';
import { ArrowLeft, CreditCard, Mail, Phone, Loader2 } from 'lucide-react';

const AdminPaymentTeamProfile: React.FC = () => {
...
export default AdminPaymentTeamProfile;