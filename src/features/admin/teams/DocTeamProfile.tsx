// src/features/admin/teams/DocTeamProfile.tsx
import React, { useEffect } from 'react';
import { useParams, useSearchParams, useNavigate } from 'react-router-dom';
import { useDispatch, useSelector } from 'react-redux';
import { AppDispatch, RootState } from '../../../store';
import { fetchUsersByTeam } from '../../../store/slices/usersSlice';
import { ArrowLeft, Users, Mail, Phone, UserCheck, Loader2 } from 'lucide-react';

const DocTeamProfile: React.FC = () => {
    ...
    <div className="w-full max-w-4xl mx-auto p-4 sm:p-6">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 mb-6">
        <div className="flex items-center gap-4 mb-4">
          <div className="w-12 h-12 rounded-xl bg-[#5f41b2]/10 flex items-center justify-center text-[#5f41b2]">
        ...
        <div className="text-sm text-slate-500">
          Team ID: #{teamId} • Members: {teamUsers.length}
        </div>
      </div>
