...
import { Building2, CheckCircle, XCircle, Loader2, ChevronDown, AlertCircle, Plus, X } from 'lucide-react';
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto border border-slate-100">
        ...
        <div className="sticky top-0 bg-white z-10 px-6 py-4 border-b border-slate-100 flex items-center justify-between rounded-t-2xl">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h3 className="text-lg font-bold text-[#1b2559]">Create New Department</h3>
              <p className="text-xs text-slate-500">Add a new department to the organization</p>
            </div>
          </div>
          <button
            onClick={handleClose}
